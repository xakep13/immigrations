$(document).ready(function () {
	...
	if ($("#add_photo").length > 0) {
		$("#add_photo").dropzone({
			url: "http://localhost.immigrant/uk/Home/SaveUploadedFile",
			clickable: "#add_photo .imit_file",
			previewsContainer: ".previewsContainer",
			previewTemplate: "<div class='added_file_row'><p name='Image' id='Image' data-dz-name></p><a href='#' data-dz-remove >Cкасувати</a></div>",
