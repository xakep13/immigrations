...
{
    [CmsAuthorize]
    public class EnterpriseCategoriesController : BaseCmsController
    {
        private EnterpriseCategoryAdminService categoryAdminService;

        public EnterpriseCategoriesController()
        {
            categoryAdminService = new EnterpriseCategoryAdminService(this.ConnectionString);
        }
        ...
        public ActionResult GetItemForm(Int32 Id = 0, Int32? ParentId = null)
        {
            ...
            return PartialView("_prtEnterpriseCategoryItemEdit", model);
        }

        [HttpPost]
        public ActionResult SaveItem(EnterpriseCategoryEdit Model)
        {
