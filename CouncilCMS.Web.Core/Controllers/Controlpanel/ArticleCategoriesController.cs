...
{
    [CmsAuthorize]
    public class ArticleCategoriesController : BaseCmsController
    {
        private ArticleCategoryAdminService categoryAdminService;
        public ArticleCategoriesController()
        {
            categoryAdminService = new ArticleCategoryAdminService(this.ConnectionString);
        }
        ...
        public ActionResult GetItemForm(Int32 Id = 0, Int32? ParentId = null)
        {
            ...
            return PartialView("_prtArticleCategoryItemEdit", model);
        }
       
        [HttpPost]
        public ActionResult SaveItem(ArticleCategoryEdit Model)
        {
