...
{
    [CmsAuthorize]
    public class PersonCategoriesController : BaseCmsController
    {
        private PersonCategoryAdminService categoryAdminService;

        public PersonCategoriesController()
        {
            categoryAdminService = new PersonCategoryAdminService(this.ConnectionString);
        }
        ...
        public ActionResult GetItemForm(Int32 Id = 0, Int32? ParentId = null)
        {
            ...
            return PartialView("_prtPersonCategoryItemEdit", model);
        }

        [HttpPost]
        public ActionResult SaveItem(PersonCategoryEdit Model)
        {
